                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kyc_status" class="form-control select2" required>
                                    ...
                                    <option value="2" {{ old('kyc_status') == 2 ? 'selected' : '' }}>Approve</option>
                                    <option value="3" {{ old('kyc_status') == 3 ? 'selected' : '' }}>Rejected</option>
                                </select>
                            </div>
                            ...
                            {{-- <div class="form-group">
                                ...
                                <select name="copy_expert_id" class="form-control select2" required>
                                    <option value="0" selected readonly>Select Copy Expert</option>
                                    @foreach ($CopyExpert as $option)
                                        <option value="{{ $option->id }}">{{ $option->profile_name }} (Win {{ $option->win_count }}%)</option>
                                    @endforeach
                                    <option value="0">No Copy Expert</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" step="any" minlength="15" class="form-control" value="{{ old('phone') }}" required>
                            </div>
