                        ...
                        <div class="col">
                            <div class="row align-items-center">
                                ...
                                <div class="col ms-n2">
                                    ...
                                    <small class="text-muted">PNG or JPG no bigger than 3MB.</small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="phone" type="text" id="phone" value="{{ old('phone', $user->phone) }}"
                                    class="form-control mb-3" placeholder="(___)___-____" />
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select mb-3" name="country">
                                    <option value="{{ old('country', $user->country) }}" selected disabled>
                                        {{ $user->country ?? 'Select Country' }}</option>
