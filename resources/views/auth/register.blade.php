...
@push('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-xl-8 my-5">
                ...
                <p class="text-muted text-center mb-5">Sign up to our dashboard.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" id="full_name" class="form-control"
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="refid" class="form-label">Referral ID (Optional)</label>
                                <input name="referral_id" type="text" id="refid" class="form-control"
                                    placeholder="{{ $referralUser->refid ?? 'Enter referral ID (if any)' }}" />
                            </div>
                        </div>
                        ...
                        {{-- <div class="col-md-12">
                            <div class="form-group">
                                <div class="g-recaptcha mt-4" data-sitekey="your-site-key-here"></div>
                            </div>
                        </div> --}}
                    </div>
